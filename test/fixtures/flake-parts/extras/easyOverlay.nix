...
in
{
  ...
  config = {
    flake.overlays.default =
      ...
      let
        system =
          prev.stdenv.hostPlatform.system or prev.system or throw
            "Could not determine the `hostPlatform` of Nixpkgs. Was this overlay loaded as a Nixpkgs overlay, or was it loaded into something else?";
