...
- [The Type Checker](./doc/book/src/type-checker.md) · [The Contract](./doc/book/src/contract.md)
- [The Language Server](./doc/book/src/lsp.md) (editor setup)
- [Configuration](./doc/book/src/configuration.md) · [Policy Rules](./doc/book/src/policy.md)
- [The Apparatus](./doc/book/src/testing.md) — how the numbers are enforced
